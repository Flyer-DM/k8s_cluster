...
```
Теперь нужно сгенерировать токен:
```
...
![Снимок экрана 2023-08-03 123244](https://github.com/Flyer-DM/k8s_cluster/assets/113033685/726fd74f-7e99-4d6b-99ba-a6a803b5ad71)

В нашем случае сервис запущен на ноде "w1" с ip 192.168.56.112 на порту 30512. Открываем браузер и печатаем: "https://192.168.56.112:30512/":

![image](https://github.com/Flyer-DM/k8s_cluster/assets/113033685/824021e1-a457-45b3-b7f3-1be0de5a9dd3)

Жмём "Подробности" -> "Сделать исключение для этого сайта". Наш dashboard открылся:

![image](https://github.com/Flyer-DM/k8s_cluster/assets/113033685/4ce6abff-4475-4090-91d4-9fd4e6e4327e)

Вставляем ранее скопированный токен и получаем доступ к дашборду нашего кластера:

![image](https://github.com/Flyer-DM/k8s_cluster/assets/113033685/85e0977b-f16f-43bc-b259-01e7ef2899ec)
 ...
 *Так мы запустили наши первые микросерсвисы* 
